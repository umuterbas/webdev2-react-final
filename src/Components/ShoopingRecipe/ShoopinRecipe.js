					...
					: recipeData.map((value, index) => {
							return (
								<div className='container' key={index}>
									...
									<div className='recipeTxtContainer'>
										{value.extendedIngredients.map((data, index) => {
											return (
												<div className='recipe' key={index}>
													<p className='aisle'>{data.aisle}</p>
													<img
										...
										{value.extendedIngredients.map((data, index) => {
											return (
												<div key={index}>
													<p className='step'>setp {index}</p>
													<p className='text'>{data.originalName}</p>
												</div>
											);
										})}
									</div>
